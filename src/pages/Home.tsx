...
import { Camera, Sparkles, ArrowRight, Users, Heart, Download, Zap, Shield, Smartphone } from 'lucide-react'
...
const Home: React.FC = () => {
  ...
  // Scroll to features section when the URL hash is #features
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 font-inter overflow-x-hidden">
      <Navigation />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden"
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-blue-400 to-cyan-400 rounded-full opacity-20 animate-pulse delay-1000"></div>
          <div className="absolute top-1/3 left-1/4 w-32 h-32 bg-gradient-to-r from-yellow-300 to-orange-300 rounded-full opacity-30 animate-bounce delay-500"></div>
          <div className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-gradient-to-r from-green-300 to-teal-300 rounded-full opacity-30 animate-bounce delay-700"></div>
        </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-32 right-32 text-3xl opacity-50"
          >
            ✨
          </motion.div>
          <motion.div
            ...
            className="absolute bottom-40 left-40 text-5xl opacity-40"
          >
            🎭
          </motion.div>
        </div>
